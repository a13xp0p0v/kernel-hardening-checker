    ...
    def test_simple_kconfig(self) -> None:
        ...
        self.assertEqual(
                ...
                [{'option_name': 'CONFIG_NAME_1', 'type': 'kconfig', 'desired_val': 'expected_1', 'decision': 'decision_1', 'reason': 'reason_1', 'check_result': 'OK', 'check_result_bool': True},
                 ...
                 {'option_name': 'CONFIG_NAME_11', 'type': 'kconfig', 'desired_val': '*expected_11*', 'decision': 'decision_11', 'reason': 'reason_11', 'check_result': 'OK', 'check_result_bool': True},
                 {'option_name': 'CONFIG_NAME_12', 'type': 'kconfig', 'desired_val': '*expected_12*', 'decision': 'decision_12', 'reason': 'reason_12', 'check_result': 'FAIL: "UNexpected_12,something"', 'check_result_bool': False},
                 {'option_name': 'CONFIG_NAME_13', 'type': 'kconfig', 'desired_val': '*expected_13*', 'decision': 'decision_13', 'reason': 'reason_13', 'check_result': 'FAIL: is off, not found', 'check_result_bool': False}]
        )
