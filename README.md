...
=========================================================================================================================
          kconfig option name           |desired val| decision |      reason      | check result
=========================================================================================================================
...
CONFIG_INTEGRITY                        |     y     |defconfig | harden_userspace | OK
CONFIG_ARCH_MMAP_RND_BITS               |    32     |  clipos  | harden_userspace | FAIL: "28"
